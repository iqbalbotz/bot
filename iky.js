...
//SETTING
ppbot = setting.ppbot
gc = `https://chat.whatsapp.com/Ch15tJVXjJrBfDW8PMhoBi`
don = `donasi nya by`
hargaSewa = `*Jasa Penyewaan Bot*
http://Wa.me/6289512333912?text=BANG+MAU+NYEWA+BOT+DONK

12PERMINGGU : 1K
PERBULAN :2 K
PERMANEN : 5K ( UDH SAMA LU PERMANEN USER PREMIUM) 

Cek fitur bot?
*wa.me/6289512333912*
2500FITUR!!! 

*JADI BOT 5K PERMANEN+PREMIUM*

*Sistem : Bot masuk Gc - Tf + bukti tf - Done*

*Antilink On,On 24 jam,anti delay Dll*`
owner = setting.owner
...
//------------------< Menunya Bang:v >-------------------
      case 'don':
      gopeynya = `https://telegra.ph/file/77ef97670d016ebe7d351.jpg`
     teksnya = `scan`
              ikyy.sendMessage(from, await getBuffer(gopeynya), image, {quoted: mek, caption: teksnya, thumbnail: Buffer.alloc(0) })
              break
      case 'infoig':
